        ...
        json_schema: {
          ...
          schema: {
            ...
            properties: {
              ...
              paragraphImageQueries: { type: "array", minItems: 1, maxItems: 12, items: { type: "object", additionalProperties: false, properties: { paragraphIndex: { type: "integer", minimum: 0, maximum: 100 }, query: { type: "string" } }, required: ["paragraphIndex", "query"] } },
              paragraphImageGenerationPrompts: { type: "array", minItems: 1, maxItems: 12, items: { type: "object", additionalProperties: false, properties: { paragraphIndex: { type: "integer", minimum: 0, maximum: 100 }, prompt: { type: "string" } }, required: ["paragraphIndex", "prompt"] } },
              imageGenerationPrompt: { type: "string" },
            },
            required: ["title", "body", "imageSearchQueries", "imagePlacementIndexes", "paragraphImageQueries", "paragraphImageGenerationPrompts", "imageGenerationPrompt"],
          },
        },
      },
      messages: [
