...
4. 친근하지만 가볍거나 과장되지 않은 여행 카페의 사람 말투로 쓰세요. 문단은 보통 2~4문장으로 하고 문단 사이에는 반드시 빈 줄을 한 줄 넣으세요. 짧은 문장과 중간 길이 문장을 섞고, 소제목·번호·불릿을 필요한 곳에만 써서 모바일에서 빨리 읽히게 하세요. 문장 끝은 '~해요', '~입니다', '~같아요', '~보시면 됩니다' 등을 자연스럽게 섞으세요. 공감 표현은 꼭 필요할 때만 쓰고, 글 성격에 맞는 서로 다른 이모지를 반드시 2~4개 자연스럽게 사용하세요. 장소 주소 앞의 📍도 이모지 수에 포함합니다. 다만 공식 공지처럼 이모지가 어울리지 않는 글만 0~1개로 줄일 수 있습니다.
